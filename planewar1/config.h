...
//游戏配置数据
#define GAME_WIDTH 1080 //界面宽度
#define GAME_HEIGHT 607//界面高度
#define GAME_TITLE "飞机大战"//标题
#define GAME_ICON ":/res/img/kunkun.ico"
...
//地图配置数据
#define MAP_PATH ":/res/img/background.png"  //默认地图1
#define MAP_SCROLL_SPEED 2  //默认地图滚动速度

//飞机配置数据
#define HERO_PATH ":/res/img/kunkun.png"//英雄飞机
//子弹配置数据
#define BULLET_PATH ":/res/img/basketball.png"//飞机子弹图片路径
#define BULLET_SPEED 5 //子弹速度
#define BULLET_NUM 30   //弹匣中子弹数目
#define BULLET_INTERVAL 20//子弹发射间隔
//敌机配置数据
#define ENEMY_PATH ":/res/img/ji.png" //敌机路径
